...
class AppFailure implements Exception {
  ...
  String get userMessage => switch (code) {
    ...
    FailureCode.calendarPermissionDenied => '没有日历权限，卡片已保存，但未写入系统日程。',
    FailureCode.calendarUnavailable => '当前设备无法创建系统日程。',
    FailureCode.calendarWriteFailed => '日程没有保存成功，可在卡片详情中重试。',
